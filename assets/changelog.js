...
const CHANGELOG = [
  {
    ...
    updates: [
      ...
      'NPC builder is now two columns: the roleplay side on the left, and a full mechanical side on the right — pick a class and level, roll ability scores (4d6 drop lowest) with AC / HP / initiative / speed / proficiency / saves calculated automatically (all editable). The Moveset box pre-fills the class\'s attack (to-hit AND damage, with multi-attack noted), spellcasting save DC + spell attack for casters, and core features for that level — and one Generate now rolls a whole NPC including class, level and stats',
      'Loot piles show their total weight and can be labelled Pile / Person / Hoard / Chest; a pile is never empty even when the value is tiny',
    ],
    fixes: [],
  },
  {
  ...
  },
  {
    ...
    updates: [
      ...
      'More filters, grouped tidily: items filter by category (Wondrous, Weapon, Armor, Potion, Ring, Staff, Wand, Rod, Scroll, Ammunition), rarity, attunement and a rough "likely source" (shop / dungeon / wild); monsters filter by type, size, alignment, movement (flies / swims / burrows / climbs), legendary and habitat/environment (Underdark, desert, urban, swamp, coastal…) — plus extra sort options (rarity for items, CR and HP for monsters)',
    ],
    fixes: [],
  },
  {
